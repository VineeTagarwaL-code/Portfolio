      ...
      <section className='flex flex-col md:flex-row gap-2 md:gap-9 col-reverse  animate__animated animate__fadeInUp'>
        ...
        <div className="flex flex-col gap-6">
          <div className='flex flex-col gap-4 mb-10'>
            <p className='text-secondary  py-1 px-2 bg-stone-900 rounded-lg max-w-[fit-content]'>Languages</p>
          ...
          <div className='flex flex-col gap-4 mb-10'>
            <p className='text-secondary  py-1 px-2 bg-stone-900 rounded-lg max-w-[80px]'>Frontend</p>
            <div className="flex gap-6 flex-wrap max-w-[400px] ">
          ...
          <div className='flex flex-col gap-4 mb-10'>
            <p className='text-secondary  py-1 px-2 bg-stone-900 rounded-lg max-w-[fit-content]'>Backend</p>
            <div className="flex gap-6 flex-wrap max-w-[400px] ">
          ...
          <div className='flex flex-col gap-4 mb-10'>
            <p className='text-secondary  py-1 px-2 bg-stone-900 rounded-lg max-w-[fit-content]'>Devops</p>
            <div className="flex gap-6 flex-wrap max-w-[400px] ">
          ...
          <div className='flex flex-col gap-4 mb-10'>
            <p className='text-secondary  py-1 px-2 bg-stone-900 rounded-lg max-w-[fit-content]'>Tools</p>
            <div className="flex gap-6 flex-wrap max-w-[400px] ">
